...
function checkFormData() {
   ...
   // 4s店名称
    var awardImageInfo = document.getElementById("awardImageInfo");
    if ( awardImageInfo.value == "" ) {
        alert( "奖品图片不能为空，请输入！" );
        return false;
    }
    
    var awardName = document.getElementById("awardName");
    if ( awardName.value == "" ) {
        alert( "奖品名称不能为空，请输入！" );
        return false;
    }
    
    var awardContent = document.getElementById("awardContent");
    if ( awardContent.value == "" ) {
        alert( "奖品简介不能为空，请输入！" );
        return false;
    }
...
<form id="awardAdd" name="awardAdd" action="award/doAdd" method="post">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 当前位置： 奖品管理 > 新增奖品</span></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="d3eaef">
      <tr>
			...
			<input type="hidden" id="awardImageInfo" name="awardImageInfo" value=""></input>
      </tr>
      <tr>
       ...
       <tr>
        <td width="30%" height="20" bgcolor="" class="STYLE6"><div align="right"><span class="STYLE10">奖品名称：</span></div></td>
        <td width="70%" height="20" bgcolor="" class="STYLE6"> <input class="span2" type="text" id="awardName" name="awardName" value=""/> </td>
      </tr>
      
       <tr>
        <td width="30%" height="20" bgcolor="" class="STYLE6"><div align="right"><span class="STYLE10">奖品简介：</span></div></td>
        <td width="70%" height="20" bgcolor="" class="STYLE6"> <input class="span2" type="text" id="awardContent" name="awardContent" value=""/> </td>
      </tr>
      
      <tr>
        <td width="5%" height="20" bgcolor="" class="STYLE6"><div align="right"><span class="STYLE10">奖励说明：</span></div></td>
        <td width="15%" height="20" bgcolor="" class="STYLE6"><input type="text" name="awardInfo" id="awardInfo" value=""/></td>
      </tr>
       <tr>
        <td width="10%" height="20" bgcolor="" class="STYLE6"><div align="right"><span class="STYLE10">奖品编号：</span></div></td>
        <td width="15%" height="20" bgcolor="" class="STYLE6"><input type="text" name="awardNumber" id="awardNumber" /></td>
      </tr>
      <tr>
       ...
       <tr>
        ...
        <td width="15%" height="20" bgcolor="" class="STYLE6"><input type="text" name="awardAddress" id="awardAddress" /></td>
      </tr>
       <tr>
        <td width="10%" height="20" bgcolor="" class="STYLE6"><div align="right"><span class="STYLE10">商家经纬度：</span></div></td>
        <td width="15%" height="20" bgcolor="" class="STYLE6"><input type="text" name="awardMap" id="awardMap" /></td>
      </tr>
       <tr>
        <td width="10%" height="20" bgcolor="" class="STYLE6"><div align="right"><span class="STYLE10">联系电话：</span></div></td>
        <td width="15%" height="20" bgcolor="" class="STYLE6"><input type="text" name="awardPhone" id="awardPhone" /></td>
      </tr>
       <tr>
        <td width="10%" height="20" bgcolor="" class="STYLE6"><div align="right"><span class="STYLE10">开始期限：</span></div></td>
        <td width="15%" height="20" bgcolor="" class="STYLE6"><input type="text"  id="awardStart" name="awardStart"/></td>
      </tr>
      <tr>
        <td width="10%" height="20" bgcolor="" class="STYLE6"><div align="right"><span class="STYLE10">结束期限：</span></div></td>
        <td width="15%" height="20" bgcolor="" class="STYLE6"><input type="text"  id="awardEnd"  name="awardEnd" /></td>
      </tr>
      <tr>
        <td width="10%" height="20" bgcolor="" class="STYLE6"><div align="right"><span class="STYLE10">兑奖暗号：</span></div></td>
        <td width="15%" height="20" bgcolor="" class="STYLE6"><input type="text"  id="awardSecret"  name="awardSecret" /></td>
      </tr>
      <tr>
        <td width="10%" height="20" bgcolor="" class="STYLE6"><div align="right"><span class="STYLE10">奖品提供者：</span></div></td>
        <td width="15%" height="20" bgcolor="" class="STYLE6"><input type="text"  id="awardProvide"  name="awardProvide" /></td>
      </tr>
      <tr>
        <td width="10%" height="20" bgcolor="" class="STYLE6"><div align="right"><span class="STYLE10">奖品出现的摇奖次数：</span></div></td>
        <td width="15%" height="20" bgcolor="" class="STYLE6"><input type="text"  id="awardRate"  name="awardRate" /></td>
      </tr>
       <tr>
