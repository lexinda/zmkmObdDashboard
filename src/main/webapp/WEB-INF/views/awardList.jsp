	       ...
	       success:function(jsonObject) {
				...
				$.each(jsonObject.list, function(i, n) { 
					...
					var image="<%=basePath%>"+n.awardImage;
					   ...
					   htmlString+="<td height='20' bgcolor='#FFFFFF' class='STYLE19'><div align='center'><a href='/award/setAward?awardId="+n.id+"' >编辑</a>&nbsp;&nbsp;<a href='/award/delete?awardId="+n.id+"' >删除</a></td>";
					   htmlString+="</tr>";
				});
  ...
  <tr>
    <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="8%" height="20"><input type="text" name="awardNumber" id="awardNumber" /></td>
