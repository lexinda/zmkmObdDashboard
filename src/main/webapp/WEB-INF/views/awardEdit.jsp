  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="d3eaef">
      ...
      <tr>
        ...
        <td width="70%" height="20" bgcolor="" class="STYLE6"> <input class="span2" type="text" id="awardName" name="awardName" value="${awardName}"/> </td>
      </tr>
      
       <tr>
        <td width="30%" height="20" bgcolor="" class="STYLE6"><div align="right"><span class="STYLE10">奖品简介：</span></div></td>
        <td width="70%" height="20" bgcolor="" class="STYLE6"> <input class="span2" type="text" id="awardContent" name="awardContent" value="${awardContent}"/> </td>
      </tr>
