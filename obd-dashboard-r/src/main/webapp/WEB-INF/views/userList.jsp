	       ...
	       success:function(jsonObject) {
				...
				$.each(jsonObject.list, function(i, n) { 
					...
					if(n.userGender === 0){
					   ...
					   htmlString+="<td height='20' bgcolor='#FFFFFF' class='STYLE19'><div align='center'>" + gender + "</div></td>";
					   htmlString+="<td height='20' bgcolor='#FFFFFF' class='STYLE19'><div align='center'>" + n.userPhone + "</div></td>";
					   htmlString+="<td height='20' bgcolor='#FFFFFF' class='STYLE19'><div align='center'>" + n.userEmail + "</div></td>";
					   ...
					   htmlString+="<td height='20' bgcolor='#FFFFFF' class='STYLE19'><div align='center'>" + n.userAmount + "</div></td>";
					   htmlString+="<td height='20' bgcolor='#FFFFFF' class='STYLE19'><div align='center'><a href='/user/userAwardList?userId="+n.id+"' >详情</a></td>";
					   htmlString+="</tr>";
				});
...
<body onload="query(1)" >
<form id="userForm" name="userForm" action="user/showList" method="get">
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <table width="100%" border="0" cellspacing="0" cellpadding="1" bgcolor="#a8c7ce">
      <tr>
        ...
        <td width="8%" height="40" align="right"><div align="right"><span class="STYLE10">电话号码:</span></div></td>
        <td width="8%" height="20"><input type="text" name="userPhone" id="userPhone" /></td>
  ...
  <tr>
    <td><table id ="stationTable" width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
      <tr>
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">账号</span></div></td>
        ...
        <td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">更新时间</span></div></td>
